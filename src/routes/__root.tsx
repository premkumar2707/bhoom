...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="spatial-atmosphere flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center">
        <h1 className="text-xl font-semibold tracking-tight text-ivory">This page didn't load</h1>
        <p className="mt-2 text-sm text-muted-foreground">
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BhuSetu — Land Intelligence Platform" },
      {
        name: "description",
        content:
          "BhuSetu harmonizes fragmented land records, cadastral data and imagery into one verifiable spatial register.",
      },
      { property: "og:title", content: "BhuSetu — Land Intelligence Platform" },
      {
        property: "og:description",
        content:
          "Intelligent land record harmonization and geospatial intelligence for land administration teams.",
      },
